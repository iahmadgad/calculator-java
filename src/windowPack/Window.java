	...
	public static void main(String[] args){
		{
			...
			pointB.setFont(new Font("Monospaced", Font.PLAIN, 11));
			...
			zeroButton.setBounds(60, 318, 50, 40);
			...
			oneButton.setBounds(10, 277, 50, 40);
			...
			twoButton.setBounds(60, 277, 50, 40);
			...
			threeButton.setBounds(110, 277, 50, 40);
			...
			fourButton.setBounds(10, 236, 50, 40);
			...
			fiveButton.setBounds(60, 236, 50, 40);
			...
			sixButton.setBounds(110, 236, 50, 40);
			...
			JLabel lblNewLabel = new JLabel("@author iAhmadGad                            JC-v0.3");
			...
			sinButton.setBounds(180, 152, 64, 40);
			...
			cosButton.setBounds(245, 152, 64, 40);
			...
			tanButton.setBounds(310, 152, 64, 40);
